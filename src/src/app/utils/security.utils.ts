...
export class Security {
    public static set(user: User, token: string) {
        ...
        localStorage.setItem('petshopuser', btoa(data));//btoa incripta o json pode adicionar um hash para ter mais segurança
    ...
    public static getUser(): User {
        ...
        if (data) {
            return JSON.parse(atob(data)); // para desencriptar
        } else {
            return null as any;
        }
    }
